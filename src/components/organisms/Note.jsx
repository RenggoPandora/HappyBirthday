          ...
          <Card className="w-full md:w-1/2 bg-white p-5 rounded-lg max-h-[80vh] flex flex-col overflow-y-auto mb-2 mt-2">
            <CardContent className="flex-grow overflow-y-auto p-4">
              <p className="text-sm md:text-base">
                ...
                Ngomong-ngomong soal tanggung jawab, ini kedokteran ni dok. Kamu nantinya kan akan menjadi seseorang yang bakal nolongin banyak orang nantinya ya. Menjadi dokter. Dokter Centryn, goks dh. Semoga dalam prosesnya, kamu selalu diberi kekuatan, ketabahan, kesabaran, rasa senang seperti kamu makan donatnya jco rasa tiramisu, oreo, blueberry tiap hari dan semangat ya buat cita-cita mulia itu (termasuk tinggal di nz dan membuka toko bunga beserta kebun-kebunnya). Kalau satu titik nanti tiba tiba kamu rasa cape ya istirahat dan liat kebelakang sudah sejauh mana kamu berproses (YA WALAUPUN AKU JUGA TAU KAMU BUKAN TIPIKAL ORG YANG AKAN MENYERAH). Terus juga kan sekarang kamu lagi ujian nih yaa, semoga diperlancar segala-galanya, bisa garap dengan tenang, ga panikan dan maksimal. JANGAN LUPA ISTIRAHAT JUGA KOCAK <br/><br/>
